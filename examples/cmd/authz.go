...
import (
	...
	"github.com/pangeacyber/pangea-go/pangea-sdk/v5/service/authz"
...
func init() {
	authzCmd := &cobra.Command{
		Use:   "authz",
		Short: "AuthZ examples",
	}

	authzCycleCmd := &cobra.Command{
		Use:  "authz_cycle",
		Args: cobra.NoArgs,
		RunE: func(cmd *cobra.Command, _ []string) error {
			return authzCycle(cmd)
		},
	}
	authzCmd.AddCommand(authzCycleCmd)

	ExamplesCmd.AddCommand(authzCmd)
}
...
func authzCycle(cmd *cobra.Command) error {
